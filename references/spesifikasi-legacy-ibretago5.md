> **Catatan penting:** dokumen ini BUKAN spesifikasi UI/fitur proyek FAZPOS.
> Ini adalah dokumentasi lengkap fitur **sistem LAMA "iB Retago 5"** yang
> sedang digantikan oleh FAZPOS. Fungsinya di sini: (1) referensi cakupan
> fitur untuk cek *feature parity* — pastikan FAZPOS tidak kehilangan fitur
> penting yang dulu ada, (2) bantu pemetaan field saat kerja di modul Import
> Legacy SQL. **Jangan mengambil keputusan arsitektur/nama tabel FAZPOS dari
> dokumen ini** — untuk itu selalu rujuk `plan.md` dan `skema-database.md`,
> karena FAZPOS sengaja tidak meniru semua pendekatan sistem lama (lihat
> `progres-pengerjaan.md` §KATEGORI 3 untuk daftar hal yang sengaja diganti).
...
> Catatan FAZPOS: 84 template `.jrxml` terpisah ini TIDAK direplikasi 1:1.
> Sesuai `progres-pengerjaan.md` §KATEGORI 3, semua laporan digantikan
> pendekatan query agregasi + tabel data langsung di UI. Daftar di bawah
> dipakai sebagai checklist cakupan LAPORAN APA SAJA yang harus tersedia,
> bukan acuan format file.
